        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div
                ...
                <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
                    ...
                    Allows users to sync their schedules with popular calendar apps (like Google Calendar, Outlook, or Apple Calendar) to automatically import their availability and add scheduled events to their personal calendars.
                    </p>
                </div>
                <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
                    ...
                    <p className="text-sm font-normal text-gray-500">
                    Allows each member to input their availability, and automatically consolidates this data to show when everyone is free. Users can select specific time slots or blocks of time, which are then displayed in a visual calendar or grid format.
                    </p>
                </div>
                <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
                    ...
                    <p className="text-sm font-normal text-gray-500">
                        Users can propose various outing options (like restaurants, activities, or events) and vote on their preferences. The feature includes options to add comments or suggest alternatives.
                    </p>
                </div>
                <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
                    ...
                    <p className="text-sm font-normal text-gray-500">
                    Sends automated reminders and notifications about upcoming events, changes in schedules, or deadlines for responses.
                    </p>
                </div>
            </div>
        </div>
